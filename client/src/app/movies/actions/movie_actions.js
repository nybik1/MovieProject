...
export const loadMovies = ({ page = 1, genres = '' } = {}) => (dispatch) => {
    ...
    axios(`https://api.themoviedb.org/3/discover/movie?api_key=4fbb4691e328ec322d3358761a861113&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&with_genres=${genres}&page=${page}
    `)
        .then(({ data }) => {
            dispatch({
...
export const searchMovies = ({ query, page, genres } = {}) => (dispatch) => {
